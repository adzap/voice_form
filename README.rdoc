...
By Adam Meehan (adam.meehan@gmail.com, http://duckpunching.com/)
...
The plugin attempts to emulate some of the VXML form flow for use in you Adhearsion components.
...
One assumption that is made in the plugin for the moment is that your call context method is 
called 'call_context'. I will remove this requirement later.
...
will move the _stack pointer_ to the field after the current field is completed and move forward
...
Also thanks to Jay Phillips for his brilliant work on Adhearsion (http://adhearsion.com).
